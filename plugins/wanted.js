...
gay = `sayang`
  ...
  let buffer = await (await fetch('https://leyscoders-api.herokuapp.com/api/img/wanted?url=' + img + '&apikey=MIMINGANZ')).buffer() // Masukan ApiKeymu disini..
  let res = await fetch('https://raw.githubusercontent.com/herokuapp-com/kuhong-api/main/info/credit.json')
  let json = await res.json()

 await conn.sendFile(m.chat, buffer, 'wanted1.jpg', 'Nih Kak', m)
